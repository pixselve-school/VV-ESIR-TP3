...
class BinaryHeapTest {
    ...
    class Pop {
        ...
        void fiveElements() {
            BinaryHeap<Integer> heap = new BinaryHeap<>(Integer::compareTo);
            heap.heap = new ArrayList<>(List.of(3, 6, 2, 10));
            assertEquals(3, heap.pop());
            assertEquals(List.of(2, 6, 10), heap.heap);
    ...
    class Parent {
        @Test
        void correctParentIndex() {
            int parent = BinaryHeap.parent(10);
            assertEquals(4, parent);
        }
    }
}
